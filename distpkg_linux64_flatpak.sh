...
flatpak-builder --user --repo=flatpak_openjkdf2 --arch=aarch64 build_linux_arm64_flatpak org.openjkdf2.OpenJKDF2.yml
#flatpak-builder --user --repo=flatpak_openjkdf2 --arch=x86_64 build_linux_x86_64_flatpak org.openjkdf2.OpenJKDF2.yml
