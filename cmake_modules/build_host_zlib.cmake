...
if(ZLIB_HOST_USE_STATIC_LIBS)
    ...
    set_property(
        ...
        ${ZLIB_HOST_ROOT}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}${ZLIB_HOST_LIBRARIES}${CMAKE_STATIC_LIBRARY_SUFFIX}
    )
else()
    ...
    set_target_properties(
        ...
        IMPORTED_LOCATION
        ${ZLIB_HOST_ROOT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}${ZLIB_HOST_LIBRARIES}${CMAKE_SHARED_LIBRARY_SUFFIX}
        IMPORTED_IMPLIB
        ${ZLIB_HOST_ROOT}/lib/${CMAKE_IMPORT_LIBRARY_PREFIX}${ZLIB_HOST_LIBRARIES}${CMAKE_IMPORT_LIBRARY_SUFFIX}
    )
