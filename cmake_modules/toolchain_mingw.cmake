...
# a redistributable CRT (msvcr120.dll etc.) so the .exe needs no shipped DLLs. Its
# printf is C89-only, so route stdio through MinGW's own C99 implementation in the
# static libmingwex -- this keeps %lld/%f/positional args correct without pulling
# in a newer CRT DLL.
...
# Everything but the system CRT (msvcrt) and kernel32 is pulled from static libs,
# so the .exe imports only guaranteed Windows system DLLs. libssp is statically
# linked here so stack-protected objects don't drag in libssp-0.dll.
