...
add_custom_command(
    OUTPUT ${GLOBALS_C}
    COMMAND python3 -m cogapp -d -D symbols_fpath="${SYMBOLS_FILE}" -D project_root="${PROJECT_SOURCE_DIR}" -o ${GLOBALS_C} ${GLOBALS_C_COG}
...
add_custom_command(
    OUTPUT ${GLOBALS_H}
    COMMAND python3 -m cogapp -d -D symbols_fpath="${SYMBOLS_FILE}" -D project_root="${PROJECT_SOURCE_DIR}" -o ${GLOBALS_H} ${GLOBALS_H_COG}
