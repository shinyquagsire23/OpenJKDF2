macro(plat_initialize)
    ...
    add_link_options(-g -mthumb -mthumb-interwork -fno-exceptions -fshort-wchar -L${LIBNDS}/lib -L${BLOCKSDS}/libs/maxmod/lib -Wl,--gc-sections -ffunction-sections -fdata-sections  --specs=${BLOCKSDS_SPECS} -Wl,--wrap,malloc -Wl,--wrap,free -Wl,--wrap,realloc -Wl,--wrap,calloc -Wl,--wrap,exit -Wl,--wrap,__muldi3 -Wl,--wrap,__aeabi_lmul -Wno-odr -flto)
