...
#define sithIntersect_sub_5080D0_ADDR (0x005080D0)
...
static int (*sithIntersect_sub_5080D0)(sithThing *thing, rdVector3 *a2, rdVector3 *a3, float a4, float a5, sithThing *a6, int a7, float *a8, rdMesh **outMesh, rdFace **a10, rdVector3 *a11) = (void*)sithIntersect_sub_5080D0_ADDR;
