...
void sithCamera_FollowFocus(sithCamera *cam)
{
    ...
    switch ( cam->cameraPerspective )
    {
        ...
        case 4:
            ...
            cam->sector = sithCamera_create_unk_struct(0, focusThing->sector, &focusThing->position, &out.scale, 0.02, SITH_RAYCAST_ONLY_COG_THINGS | RAYCAST_200);
            ...
            cam->sector = sithCamera_create_unk_struct(0, cam->sector, &v84, &cam->viewMat.scale, 0.02, SITH_RAYCAST_ONLY_COG_THINGS | RAYCAST_200);
            break;
        case 32:
            ...
            cam->sector = sithCamera_create_unk_struct(0, focusThing->sector, &focusThing->position, &cam->viewMat.scale, 0.02, SITH_RAYCAST_ONLY_COG_THINGS | RAYCAST_200);
            rot.x = 0.0;
