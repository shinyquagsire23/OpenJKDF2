...
enum SithSurfaceFlag
{
    ...
    SITH_SURFACE_1000 = 0x1000, // Jones specific: KILL_FLOOR
    SITH_SURFACE_2000 = 0x2000, // Jones specific: CLIMBABLE
    SITH_SURFACE_4000 = 0x4000, // Jones specific: TRACK
...
enum SithSurfaceAdjoinFlag
{
    ...
    SITHSURF_ADJOIN_ALLOW_MOVEMENT = 0x2,
