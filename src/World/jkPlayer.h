...
extern flex32_t jkPlayer_ssaaMultiple;
extern int jkPlayer_enableSSAO;
extern flex32_t jkPlayer_gamma;
extern flex32_t jkPlayer_hudScale;
extern flex32_t jkPlayer_crosshairLineWidth;
extern flex32_t jkPlayer_crosshairScale;
extern flex32_t jkPlayer_canonicalCogTickrate;
extern flex32_t jkPlayer_canonicalPhysTickrate;
