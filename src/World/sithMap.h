...
MATH_FUNC void sithMap_sub_4EC4D0(SithSector *pSector);
MATH_FUNC int sithMap_Draw(SithSector *pSector);
MATH_FUNC int sithMap_IsSurfaceDrawable(SithSurface *pSurface, int vertIdx, int nextVertIdx);
