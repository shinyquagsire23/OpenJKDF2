...
//static int32_t (__cdecl *sithCogExec_PopProgramVal)(sithCog *cog) = (void*)sithCogExec_PopProgramVal_ADDR;
//static int32_t (__cdecl *sithCogExec_PopStackVar)(sithCog *cog, sithCogStackvar *out) = (void*)sithCogExec_PopStackVar_ADDR;
...
//static void (__cdecl *sithCogExec_MathOperation)(sithCog *cog, int32_t op) = (void*)sithCogExec_MathOperation_ADDR;
//static void (__cdecl *sithCogExec_BitOperation)(sithCog *cog, int32_t op) = (void*)sithCogExec_BitOperation_ADDR;
//static int32_t (__cdecl *sithCogExec_PopValue)(sithCog *ctx, int32_t *out) = (void*)sithCogExec_PopValue_ADDR;
...
//static int32_t (__cdecl *sithCogExec_PopVector3)(sithCog *ctx, rdVector3* out) = (void*)sithCogExec_PopVector3_ADDR;
...
//static int32_t (__cdecl *sithCogExec_PopSymbolIdx)(sithCog *ctx) = (void*)sithCogExec_PopSymbolIdx_ADDR;
