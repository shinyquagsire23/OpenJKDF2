...
//static int32_t (__cdecl *sithCogExec_PopStack)(sithCog *cog, sithCogStackvar *out) = (void*)sithCogExec_PopStack_ADDR;
//static sithCogStackvar* (__cdecl *sithCogExec_GetSymbolValue)(sithCogStackvar *a1, sithCog* a2, sithCogStackvar *a3) = (void*)sithCogExec_GetSymbolValue_ADDR;
...
//static void (__cdecl *sithCogExec_PushStack)(sithCog *ctx, sithCogStackvar *val) = (void*)sithCogExec_PushStack_ADDR;
