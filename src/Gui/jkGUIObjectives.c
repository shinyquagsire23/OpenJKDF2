...
void jkGuiObjectives_CustomRender(jkGuiElement *element, jkGuiMenu *menu, tVBuffer *vbuf, int bRedraw)
{
    ...
    for (int i = 0; i < 50; i++)
    {
        ...
        int goal_flags = (__int64)sithInventory_GetInventory(sithPlayer_g_pLocalPlayerThing, i + SITHBIN_GOAL00);
...
int jkGuiObjectives_Show()
{
    ...
    v0 = (__int64)sithInventory_GetInventory(sithPlayer_g_pLocalPlayerThing, 99);
    if ( v0 )
    {
        for (v1 = 0; v1 < 50; v1++)
        {
