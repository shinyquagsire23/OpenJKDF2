...
enum SITH_AF
{
    SITH_AF_UNKNOWN_1 = 0x1,
    SITH_AF_UNKNOWN4 = 0x4,
    ...
    SITH_AF_SLIDE_SLOPE = 0x10000, // prob. Jones specific
    SITH_AF_DELAYFIRE = 0x20000,
    SITH_AF_IMMOBILE = 0x40000,
    SITH_AF_NOTARGET = 0x100000,
    SITH_AF_DISABLED = 0x200000,
    SITH_AF_PLAYER_KILLED = 0x400000,
    SITH_AF_UNKNOWN_800000 = 0x800000,
    SITH_AF_UNKNOWN_1000000 = 0x1000000,
    SITH_AF_UNKNOWN_8000000 = 0x8000000,
    SITH_AF_FLYERMOVE = 0x10000000,
    SITH_AF_UNKNOWN_0x20000000 = 0x20000000,
