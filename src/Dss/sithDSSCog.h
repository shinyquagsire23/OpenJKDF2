...
int sithDSSCog_SendSendTrigger(sithCog *a1, int a2, int a3, int a4, int a5, int a6, int a7, flex32_t a8_, flex32_t a8, flex32_t a9, flex32_t a10, int a11);
...
//static int (*sithDSSCog_SendSendTrigger)(sithCog* a1, int a2, int a3, int a4, int a5, int a6, int a7, flex32_t a8_, flex32_t a8, flex32_t a9, flex32_t a10, int a11) = (void*)sithDSSCog_SendSendTrigger_ADDR;
