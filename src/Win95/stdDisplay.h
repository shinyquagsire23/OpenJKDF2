...
static stdVBuffer* (__cdecl *stdDisplay_VBufferNew)(stdVBufferTexFmt *a1, int create_ddraw_surface, int gpu_mem, const void* palette) = (void*)stdDisplay_VBufferNew_ADDR;
