...
static int (*stdDisplay_VBufferFill)(tVBuffer *a2, int fillColor, rdRect *a4) = (void*)stdDisplay_VBufferFill_ADDR;
static int (*stdDisplay_VBufferCopy)(tVBuffer *vbuf, tVBuffer *vbuf2, unsigned int blit_x, int blit_y, rdRect *rect, int alpha_maybe) = (void*)stdDisplay_VBufferCopy_ADDR;
...
static tVBuffer* (__cdecl *stdDisplay_VBufferNew)(tRasterInfo *a1, int create_ddraw_surface, int gpu_mem, const void* palette) = (void*)stdDisplay_VBufferNew_ADDR;
static int (__cdecl *stdDisplay_VBufferLock)(tVBuffer *a1) = (void*)stdDisplay_VBufferLock_ADDR;
static void (__cdecl *stdDisplay_VBufferUnlock)(tVBuffer *a1) = (void*)stdDisplay_VBufferUnlock_ADDR;
static int (__cdecl *stdDisplay_VBufferSetColorKey)(tVBuffer *a1, int color) = (void*)stdDisplay_VBufferSetColorKey_ADDR;
static void (__cdecl *stdDisplay_VBufferFree)(tVBuffer *a1) = (void*)stdDisplay_VBufferFree_ADDR;
...
static tVBuffer* (*stdDisplay_VBufferConvertColorFormat)(void* a, tVBuffer* b) = (void*)stdDisplay_VBufferConvertColorFormat_ADDR;
...
int stdDisplay_VBufferFill(tVBuffer *a2, int fillColor, rdRect *a4);
...
tVBuffer* stdDisplay_VBufferNew(tRasterInfo *a1, int create_ddraw_surface, int gpu_mem, const void* palette);
int stdDisplay_VBufferLock(tVBuffer *a1);
void stdDisplay_VBufferUnlock(tVBuffer *a1);
