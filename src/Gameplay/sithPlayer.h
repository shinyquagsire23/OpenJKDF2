...
MATH_FUNC void sithPlayer_Update(sithPlayerInfo *playerInfo, flex_t a2);
...
//static void (*sithPlayer_Update)(sithPlayerInfo *playerInfo, flex_t a2) = (void*)sithPlayer_Update_ADDR;
