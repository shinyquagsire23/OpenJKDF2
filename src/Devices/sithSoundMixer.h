...
//static sithPlayingSound* (*sithSoundMixer_PlaySoundPosThing)(sithSound *a1, sithThing *a2, flex_t a3, flex_t a4, flex_t a5, int a6) = (void*)sithSoundMixer_PlaySoundPosThing_ADDR;
