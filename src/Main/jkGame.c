...
int jkGame_Update()
{
    ...
    */
    ...
    stdPlatform_Printf("dlt all=%d mn=%d %d wrld=%d\n pov=%d hud=%d drw=%d wst=%d\n", total_delta-std3D_timeWastedWaitingAround, sithMain_tickEndMs-sithMain_tickStartMs, jkGame_Delta_ClearScreen_AdvanceFrame, jkGame_Delta_AdvanceFrame_UpdateCamera, jkGame_Delta_UpdateCamera_DrawPov, jkGame_Delta_DrawPov_HudDrawn, jkGame_Delta_HudDrawn_End - std3D_timeWastedWaitingAround, std3D_timeWastedWaitingAround);
    //world=28 drw=15 emu
