...
#define stdControl_SetActivation_ADDR (0x0042ED40)
#define stdControl_ShowMouseCursor_ADDR (0x0042EDC0)
...
#define stdControl_RegisterAxis_ADDR (0x0042F090)
...
MATH_FUNC void stdControl_RegisterAxis(int index, int stickMin, int stickMax, flex_t multiplier);
...
static void (*stdControl_SetActivation)(int a1) = (void*)stdControl_SetActivation_ADDR;
static int (*stdControl_ShowMouseCursor)(BOOL bShow) = (void*)stdControl_ShowMouseCursor_ADDR;
