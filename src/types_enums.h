...
typedef int32_t rdStencilBufferMethod_t;
enum RD_STENCILBUFFERMETHOD
{
	RD_STENCIL_NOREAD_NOWRITE = 0,
	RD_STENCIL_NOREAD_WRITE = 1,
	RD_STENCIL_READ_WRITE = 2,
	RD_STENCIL_READ_NOWRITE = 3,
};
#endif
