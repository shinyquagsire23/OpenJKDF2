...
MATH_FUNC FAST_FUNC void rdMatrix_PreMultiply34(rdMatrix34 *mat1, const rdMatrix34 *mat2);
MATH_FUNC void rdMatrix_PreMultiply44(rdMatrix44 *mat1, const rdMatrix44 *mat2);
MATH_FUNC FAST_FUNC void rdMatrix_PostMultiply34(rdMatrix34 *mat1, const rdMatrix34 *mat2);
MATH_FUNC void rdMatrix_PostMultiply44(rdMatrix44 *mat1, const rdMatrix44 *mat2);
MATH_FUNC void rdMatrix_PreRotate34(rdMatrix34 *out, const rdVector3 *rot);
MATH_FUNC void rdMatrix_PreRotate44(rdMatrix44 *out, const rdVector3 *rot);
MATH_FUNC void rdMatrix_PostRotate34(rdMatrix34 *out, const rdVector3 *rot);
MATH_FUNC void rdMatrix_PostRotate44(rdMatrix44 *out, const rdVector3 *rot);
MATH_FUNC void rdMatrix_PreTranslate34(rdMatrix34 *out, const rdVector3 *trans);
MATH_FUNC void rdMatrix_PreTranslate44(rdMatrix44 *out, const rdVector3 *tV);
MATH_FUNC void rdMatrix_PostTranslate34(rdMatrix34 *out, const rdVector3 *trans);
MATH_FUNC void rdMatrix_PostTranslate44(rdMatrix44 *out, const rdVector3 *tV);
MATH_FUNC void rdMatrix_PreScale34(rdMatrix34 *out, const rdVector3 *scale);
MATH_FUNC void rdMatrix_PreScale44(rdMatrix44 *out, const rdVector4 *scale);
MATH_FUNC void rdMatrix_PostScale34(rdMatrix34 *out, const rdVector3 *scale);
