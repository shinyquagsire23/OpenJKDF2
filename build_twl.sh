...
DEBUG_QOL_CHEATS=0
(EXPERIMENTAL_FIXED_POINT=$EXPERIMENTAL_FIXED_POINT DEBUG_QOL_CHEATS=$DEBUG_QOL_CHEATS cmake .. --toolchain $(pwd)/../cmake_modules/toolchain_twl.cmake || EXPERIMENTAL_FIXED_POINT=$EXPERIMENTAL_FIXED_POINT DEBUG_QOL_CHEATS=$DEBUG_QOL_CHEATS cmake .. --toolchain $(pwd)/../cmake_modules/toolchain_twl.cmake) &&
