...
EXPERIMENTAL_FIXED_POINT=$EXPERIMENTAL_FIXED_POINT DEBUG_QOL_CHEATS=$DEBUG_QOL_CHEATS cmake .. --project-file=CMakeLists.txt --toolchain $DEVKITPRO/cmake/Switch.cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=1 &&
