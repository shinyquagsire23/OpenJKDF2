...
mkdir -p "~/Library/Application Support/OpenJKDF2/openjkmots/resource/shaders/" &&
cp resource/shaders/* "~/Library/Application Support/OpenJKDF2/openjkmots/resource/shaders/" &&
echo "Running..." &&
