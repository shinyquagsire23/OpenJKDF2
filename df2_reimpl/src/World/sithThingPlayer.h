...
static int (*sithThingPlayer_cogMsg_SendSendTrigger)(int a1, int a2, int a3, int a4, int a5, int a6, int a7, float a8_, float a8, float a9, float a10, int a11) = (void*)sithThingPlayer_cogMsg_SendSendTrigger_ADDR;
static int (*sithThingPlayer_cogMsg_SendSyncCog)(sithCog *a1, int a2, int a3) = (void*)sithThingPlayer_cogMsg_SendSyncCog_ADDR;
