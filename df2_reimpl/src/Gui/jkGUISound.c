...
static jkGuiElement jkGuiSound_elements[25] = {
    ...
    {ELEMENT_SLIDER, 0, 0, 100, 0, {300, 160, 320, 30}, 1, 0, "GUI_MUSICVOLUME_HINT", 0, 0, slider_1, {0}, 0},
    ...
    {ELEMENT_SLIDER, 0, 0, 100, 0, {300, 245, 320, 30}, 1, 0, "GUI_SFXVOLUME_HINT", 0, 0, slider_1, {0}, 0},
    ...
    {ELEMENT_SLIDER, 0, 0, 16, 0, {300, 335, 320, 30}, 1, 0, "GUI_DIGICHANNELS_HINT", 0, 0, slider_1, {0}, 0},
